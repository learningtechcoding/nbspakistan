...
<head>
    ...
    <title>Nation Blood Society</title>
...
<body>
    ...
    <section id="about" class="contianer-fluid card about-us cardShadow">
        <div class="container">
            <div class="row session-title">
                <h2 class="headingB">About Us</h2>
    ...
    <!-- ################# Gallery Start Here #######################--->
<div class="card cardShadow mt-2">
    <div id="gallery" class="gallery container-fluid ">
        <div class="container">
            <div class="row session-title">
                <h2>
                    <h2 class="mb-3 text-center headingB">Checkout our Gallery</h2>
                </h2>
            </div>
    ...
    <div class="container ">
        <div class="row mt-2 mb-2 mt-md-2 mb-md-2 d-flex flex-row">
            @foreach ($galleries as $gallery)
                <div class="col-3 mt-2 mb-2 mt-md-2 mb-md-2 ">
                    <img src="/storage/images/{{ $gallery->image }}" class="rounded float-start"
                        alt="{{ $gallery->title }}">
                </div>
            @endforeach
            {{-- <div class="col-3">
    ...
    <section id="process" class="donation-care card cardShadow mt-2">
        <div class="container">
            <div class="row session-title">
                <h2 class="headingB">Donation Process</h2>
    ...
    <div id="blog" class="blog-container contaienr-fluid card cardShadow mt-2">
        <div class="container">
            <div class="session-title row">
                <h2 class="headingB">Latest Blog</h2>
        ...
        <div class="container">
            ...
            <div class="row content-ro">
                <div class="col-lg-4 col-md-12 footer-contact">
                    <h2 class="">Contact Informatins</h2>
